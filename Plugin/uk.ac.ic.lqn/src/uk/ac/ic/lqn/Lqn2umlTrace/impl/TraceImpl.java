 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.ic.lqn.Lqn2umlTrace.impl.TraceImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TraceImpl extends MinimalEObjectImpl.Container implements Trace {
	...
	protected EClass eStaticClass() {
		return Lqn2umlTracePackage.Literals.TRACE;
	}
	...
	public EList<TraceLink> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<TraceLink>(TraceLink.class, this, Lqn2umlTracePackage.TRACE__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Lqn2umlTracePackage.TRACE__LINKS:
